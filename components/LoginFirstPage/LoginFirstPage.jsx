            ...
            <div className="md:flex container pt-5 w-full justify-center items-start mt-20">
                ...
                <div className="w-full md:w-5/12 px-5 flex-col justify-center items-center">
                    <div className="md:ml-8 w-full md:px-8">
                        ...
                        <button disabled type="submit" className="text-white bg-slate-400 active:ring-4 font-medium rounded-lg text-sm w-full py-2">Submit</button>

                        <h5 htmlFor="remember" className="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400 mt-10">Don't have an account ? <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">Sign Up Here</a>.</h5>
                    </div>
                </div>
